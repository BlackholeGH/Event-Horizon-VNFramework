        ...
        public static object[] RetrieveScriptByName(String S)
        {
            ...
            switch (S.ToUpper())
            {
                ...
                case "VS_MAIN_INTRO":
                    ...
                    break;
                case "SOFIA_MAIN_INTRO":
                    Script = new object[]
                    {
                        new object[] { "C|TIME:0", new VoidDel(delegate() { Shell.RunQueue.Add(new VoidDel(ButtonScripts.InitDefaultUI)); }) },
                        new object[] { "C|GWS:CONTINUE", "M|SOURCE|TRUE", "T||Life. [T:500]The great wet slip-and-dip along the universe's waterslide of madness." },
                        new object[] { "C|GWS:CONTINUE", "T||We are brought into this world as small screaming pink entities, and do we know where we're going? Can we forsee what the tides of time hold for us?" },
                        new object[] { "C|GWS:CONTINUE", "T||No. [T:500]We don't know jack shit." },
                        new object[] { "C|GWS:CONTINUE", "T||We might grow up to be hard working nut-farmers, endlessly tilling the fields to plant just one more massive coconut tree." },
                        new object[] { "C|GWS:CONTINUE", "T||We might find ourselves hard pressed legal assistants, diving into mounds of paperwork with only our wits and a pen in order to prove, once and for all, that monkeys are people too." },
                        new object[] { "C|GWS:CONTINUE", "T||Or, we might just become..." },
                        new object[] { "C|GWS:CONTINUE", "M|#NULL|", "T||SOFIA." },
                        new object[] { "C|GWS:CONTINUE", "M|ORDINARY|TRUE", new VoidDel(delegate()
                        {
                            Shell.RunQueue.Add(new VoidDel(delegate()
                            {
                                ActivateScriptElement("T||" + System.DateTime.Now.DayOfWeek.ToString().ToUpper() + ". [T:500]GILLETTE RESIDENCE. [T:500]" + System.DateTime.Now.ToString("hh:mm tt") + ".");
                        ...
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|Ah, what a good day it is.", "F|SOFIA|HAPPY" },
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|A good day... to be SOFIAING.", "F|SOFIA|GRINNING" },
                        new object[] { "C|GWS:CONTINUE", "T||Little did Sofia know that this day would be a day like no other in her life so far." },
                        new object[] { "C|GWS:CONTINUE", "T||That today... would be one to DEFINE her." },
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|I suppose I should go indoors..." },
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|Wait.", "F|SOFIA|WORRIED" },
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|What's this?" },
                        new object[] { "C|TIME:2000:ORSKIP", "T||", new VoidDel(delegate()
                        {
                            Shell.RunQueue.Add(new VoidDel(delegate()
                            {
                                WorldEntity Add = new WorldEntity("LETTER", new Vector2(900, 900), (TAtlasInfo)Shell.AtlasDirectory["LETTER"], 0.4f);
                                Add.CenterOrigin = true;
                                Animation A = new Animation("moveupin");
                                A.WriteMovement(Animation.CreateVectorTween(new Vector2(0, -600), 1500, 20));
                        ...
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|A letter on the doorstep?", "F|SOFIA|THINKING" },
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|And it's addressed to me...", "F|SOFIA|THINKING" },
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|Awesome! I'm gonna open it!", "F|SOFIA|EXCITED" },
                        new object[] { "C|GWS:CONTINUE", "T|Letter|Greetings, Sofia.",  "F|SOFIA|THINKING" },
                        new object[] { "C|GWS:CONTINUE", "T|Letter|I trust this letter reaches you in good time." },
                        new object[] { "C|GWS:CONTINUE", "T|Letter|That is, to the extent that time has meaning in YOUR WORLD." },
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|Wow. [T:300]Whoever wrote this is really overdramatic.", "F|SOFIA|JUDGING" },
                        new object[] { "C|GWS:CONTINUE", "T|Letter|Soon you will learn that these things have no meaning.", "F|SOFIA|THINKING" },
                        new object[] { "C|GWS:CONTINUE", "T|Letter|TIME. [T:500]THOUGHT. [T:500]REALITY." },
                        new object[] { "C|GWS:CONTINUE", "T|Letter|These are all but nothing. You shall come to know this before long.", "F|SOFIA|CONSIDERING" },
                        new object[] { "C|GWS:CONTINUE", "T|Letter|Many things will be revealed to you, once you leave YOUR WORLD..." },
                        new object[] { "C|TIME:1600:ORSKIP", "T|Letter|...and enter [R]OUR WORLD[C:WHITE].", "F|SOFIA|UNIMPRESSED" },
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|LAUGHING" },
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|Well... I have absolutely no idea what that was supposed to mean!" },
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|Oh wait, there's more.", "F|SOFIA|THINKING" },
                        new object[] { "C|GWS:CONTINUE", "T|Letter|Many great, wondrous and terrifying things await you." }, 
                        new object[] { "C|GWS:CONTINUE", "T|Letter|To discover your true destiny, enter the secret trapdoor down the alleyway beside your house." },
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|The... the what now?", "F|SOFIA|WORRIED" },
                        new object[] { "C|TIME:1300:ORSKIP", "T|Sofia|There isn't... [T:1200]Oh." },
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|UNIMPRESSED" },
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|Well that definitely wasn't there before." },
                        new object[] { "C|GWS:CONTINUE", "T|Letter|...fare you well, [R]SOFIA[C:WHITE]." },
                        new object[] { "C|GWS:CONTINUE", "T|Letter|See you soon. - A Friend." },
                        new object[] { "C|GWS:CONTINUE", "T|Letter|P.S.: Bring me some crisps, I'm bloody starving." },
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|Well, this day took a sudden and unexpected turn for the utterly insane.", "F|SOFIA|THINKING" },
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|I wonder what I should do now. Can this letter be trusted?" },
                        new object[] { "C|GWS:impos", "T||", new VoidDel(delegate()
                        {
                            Shell.RunQueue.Add(new VoidDel(delegate()
                            {
                                //Shell.Ser = true;
                                Button B = ButtonScripts.GetQuickButton("Venture down into the mysterious trapdoor.", ButtonScripts.DelegateFetch("runscript_SOFIA_VENTURE"));
                                B.MLCRecord = new String[] { "runscript_SOFIA_VENTURE" };
                                B.QuickMoveTo(new Vector2(640, 200));
                                Button B2 = ButtonScripts.GetQuickButton("Screw that. Go back indoors and draw some lizards.", ButtonScripts.DelegateFetch("runscript_SOFIA_DRAW"));
                                B2.MLCRecord = new String[] { "runscript_SOFIA_DRAW" };
                ...
                case "SOFIA_DRAW":
                    Script = new object[]
                    {
                        new object[] { "C|GWS:CONTINUE", "D|#CBUTTONS", "T||Nah, this whole thing is just a little too weird for you. Mysterious letters? Inexplicable trapdoors? Sounds like a good way to have a bad time. You're not messing with this shit.", "A|LETTER|FADEOUT" },
                        new object[] { "C|GWS:CONTINUE", "T||You'd rather just go back indoors and continue living your life as normal, never thinking about all of this again.", "D|LETTER" },
                        new object[] { "C|GWS:CONTINUE", "T||So you go do that." },
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|UNIMPRESSED", "T||Unfortunately, seeing as the entire premise of this game is predicated on you (Sofia) going and investigating the mystery, that also means that we have reached an impasse, and the story can't progress any further." },
                        new object[] { "C|GWS:CONTINUE", "T||Oops." },
                        new object[] { "C|GWS:CONTINUE", "T||Still, I hope you had fun! Maybe better luck next time." },
                        new object[] { "C|TIME:1700", "T||Goodbye...", new VoidDel(delegate()
                        {
                            Shell.RunQueue.Add(new VoidDel(delegate()
                            {
                                WorldEntity Add = new WorldEntity("BLACK", new Vector2(0, 0), (TAtlasInfo)Shell.AtlasDirectory["BLACK"], 0.9601f);
                        ...
                        new object[] { "B|#MAINMENU" }
                    };
                    break;
                case "SOFIA_VENTURE":
                    Script = new object[]
                    {
                        new object[] { "C|GWS:CONTINUE", "D|#CBUTTONS", "T||You decide to pursue your destiny. After all, stepping into mysteriously appearing trapdoors at the behest of a spooky anonymous letter doesn't sound at all like the sort of thing that could have a very bad outcome.", "A|LETTER|FADEOUT", "A|HOUSEBG|FADEOUT" },
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|So did this, like, just appear here?", "F|SOFIA|WORRIED", "D|HOUSEBG", "D|LETTER" },
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|Or has it been here all along and I've just completely missed it...", "F|SOFIA|UNIMPRESSED" },
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|Either way, weird.", "F|SOFIA|THINKING" },
                        new object[] { "C|GWS:CONTINUE", "M|#NULL", "S|#CLOSEALL|", "T|Sofia|Now, let me just... shimmy down here...", "F|SOFIA|DOWNCAST", new VoidDel(delegate()
                        {
                            Shell.RunQueue.Add(new VoidDel(delegate()
                            {
                                WorldEntity Add = new WorldEntity("CELLARBG", new Vector2(0, 0), (TAtlasInfo)Shell.AtlasDirectory["CELLARBG"], 0.05f);
                                Add.ColourValue = new Color(0,0,0,0);
                                Add.AnimationQueue.Add(Animation.Retrieve("FADEIN"));
                                Shell.UpdateQueue.Add(Add);
                                Shell.RenderQueue.Add(Add);
                        ...
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|Oh. [T:700]Whoa.", "F|SOFIA|UNIMPRESSED" },
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|Well, at least this isn't weird at all. [T:600]...Not.", "F|SOFIA|WORRIED" },
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|Wait, no scratch that. Scratch that weirdness rating. What is THAT.", "F|SOFIA|JUDGING" },
                        new object[] { "C|TIME:2000:ORSKIP", "M|PORTAL|TRUE", "T||", new VoidDel(delegate()
                        {
                            Shell.RunQueue.Add(new VoidDel(delegate()
                            {
                                WorldEntity Add = new WorldEntity("PORTAL", new Vector2(1280, 0), (TAtlasInfo)Shell.AtlasDirectory["PORTAL"], 0.4f);
                                Animation A = new Animation("moveleftin");
                                A.WriteMovement(Animation.CreateVectorTween(new Vector2(-1280, 0), 1500, 20));
                                Add.AnimationQueue.Add(A);
                                Shell.UpdateQueue.Add(Add);
                                Shell.RenderQueue.Add(Add);
                            }));
                        ...
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|What. [T:700]The heck." },
                        new object[] { "C|GWS:CONTINUE", "T|Purple thing|vvvvvRRRRRRhhhhRRRhhEEEERRRRRRAAARRRARARARZARAAAA!!!" },
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|It's sort of... glowy.", "F|SOFIA|CONSIDERING" },
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|And uh, floating." },
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|Well, clearly the only logical thing to do in this situation is to touch it!", "F|SOFIA|GRINNING" },
                        new object[] { "C|TIME:1000:ORSKIP", "S|LASERBUILD|FALSE", "T|Sofia|Here I go!", "A|SOFIA|600=0,1000,20||||" },
                        new object[] { "C|TIME:500:ORSKIP", "S|LASERBLAST|FALSE", "M|#NULL|", "T||", new VoidDel(delegate()
                        {
                            Shell.RunQueue.Add(new VoidDel(delegate()
                            {
                                WorldEntity Add = new WorldEntity("FLASHER", new Vector2(0, 0), (TAtlasInfo)Shell.AtlasDirectory["BGFLASHER"], 0.8f);
                                Animation A = Animation.Retrieve("01OSCILLATE");
                                Add.AnimationQueue.Add(A);
                                Shell.UpdateQueue.Add(Add);
                                Shell.RenderQueue.Add(Add);
                            }));
                        ...
                        new object[] { "C|TIME:3000:ORSKIP", "D|SOFIA", "D|PORTAL", "D|CELLARBG", "D|FLASHER" },
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|..." },
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|W-what the...", new VoidDel(delegate()
                        {
                            Shell.RunQueue.Add(new VoidDel(delegate()
                            {
                                WorldEntity Add = new WorldEntity("SOFIA", new Vector2(350, 405), (TAtlasInfo)Shell.AtlasDirectory["SOFIASPRITES"], 0.5f);
                        ...
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|Where am... I......", "M|DARKLING|TRUE", "F|SOFIA|THINKING" },
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|Holy shit.", "F|SOFIA|WORRIED", new VoidDel(delegate()
                        {
                            Shell.RunQueue.Add(new VoidDel(delegate()
                            {
                        ...
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|I have no idea where I am, but I'm pretty sure this isn't under the house." },
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|Or, if it is, then heck yeah, awesome!", "F|SOFIA|LAUGHING" },
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|But... no. No, I think I'm...", "F|SOFIA|THINKING" },
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|Somewhere else entirely.", "F|SOFIA|WORRIED" },
                        new object[] { "C|TIME:1200:ORSKIP", "T|???|HALT.", "F|SOFIA|THINKING" },
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|JUDGING" },
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|What? Who said... Is someone there?", "F|SOFIA|HAPPY" },
                        ...
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|WORRIED", "T|Golem Sofia|HALT. STATE YOUR SECTOR AND DESIGNATION.", "A|GOLEM SOFIA|-500=0,1000,20||||" },
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|UNIMPRESSED", "T|Sofia|Oh my God." },
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|EXCITED", "T|Sofia|Nobody told me that we were doing clones!" },
                        new object[] { "C|GWS:CONTINUE", "F|GOLEM SOFIA|PLACID", "T|Golem Sofia|DOING WHAT NOW?" },
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|HAPPY", "T|Sofia|Clones! Are you a clone?" },
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|THINKING", "T|Sofia|I mean you definitely seem to be a clone, but the weird Tron parts do kinda throw me for a loop a little." },
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|CONSIDERING", "T|Sofia|Are you, like, a cyborg clone?" },
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|Or wait, maybe you are me from like, an alternate dimension..." },
                        new object[] { "C|GWS:CONTINUE", "F|GOLEM SOFIA|STARE", "F|SOFIA|GRINNING", "T|Sofia|...where everything is pink, and we wear freaky robot masks?" },
                        new object[] { "C|GWS:CONTINUE", "T|Golem Sofia|...WHO ARE YOU" },
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|I'm Sofia! [T:500]Hi!" },
                        new object[] { "C|GWS:CONTINUE", "F|GOLEM SOFIA|GRINNING", "T|Golem Sofia|YEAH, NO SHIT SHERLOCK." },
                        new object[] { "C|GWS:CONTINUE", "T|Golem Sofia|TELL ME WHAT ELSE IS NEW." },
                        new object[] { "C|GWS:CONTINUE", "F|GOLEM SOFIA|STARE", "F|SOFIA|WORRIED", "T|Golem Sofia|REGARDLESS. CONFIRM DESIGNATION OR YOU WILL BE REMANDED IN CUSTODY." },
                        new object[] { "C|GWS:CONTINUE", "F|GOLEM SOFIA|PLACID", "T|???|Whoa there, whoa there. Take it easy, girls." },
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|DOWNCAST", "T|Sofia|Oh God, what now..." },
                        new object[] { "C|TIME:0", new VoidDel(delegate()
                        {
                            Shell.RunQueue.Add(new VoidDel(delegate()
                            {
                                WorldEntity Add = new WorldEntity("COOL SOFIA", new Vector2(1430, 435), (TAtlasInfo)Shell.AtlasDirectory["COOLSOFIA"], 0.4f);
                                Add.CenterOrigin = true;
                                Add.SetAtlasFrame(new Point(3, 1));
                                Add.Scale(new Vector2(-0.15f, -0.15f));
                                Shell.UpdateQueue.Add(Add);
                                Shell.RenderQueue.Add(Add);
                            }));
                        })
                        },
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|UNIMPRESSED", "T|Cool Sofia|There's no need for fighting.", "A|COOL SOFIA|-750=0,1000,20||||" },
                        new object[] { "C|GWS:CONTINUE", "F|COOL SOFIA|EXCITED", "T|Cool Sofia|After all, we're all Sofia here." },
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|WORRIED", "F|GOLEM SOFIA|STARE", "T|Golem Sofia|STILL AWAITING DESIGNATION CONFIRMATION.." },
                        new object[] { "C|GWS:CONTINUE", "F|GOLEM SOFIA|PLACID", "T|Golem Sofia|IF YOU'RE, YOU KNOW. DONE TALKING." },
                        new object[] { "C|GWS:CONTINUE", "F|COOL SOFIA|HAPPY", "F|GOLEM SOFIA|STARE", "T|Cool Sofia|Hey, cool it ugly. She's with me." },
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|JUDGING", "T|Sofia|Hey, rude!" },
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|THINKING", "T|Sofia|...Also, what? Am I?" },
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|WORRIED", "T|Sofia|Who even are you? [T:500]Why do you look like me?", "F|COOL SOFIA|LAUGHING" },
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|DOWNCAST", "T|Cool Sofia|I'm Cool Sofia. Sup.", "F|COOL SOFIA|GRINNING" },
                        new object[] { "C|GWS:CONTINUE", "F|GOLEM SOFIA|STARE", "T|Golem Sofia|DESIGNATION VERIFIED." },
                        new object[] { "C|GWS:CONTINUE", "F|GOLEM SOFIA|PLACID", "T|Golem Sofia|*AHEM*" },
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|UNIMPRESSED", "F|GOLEM SOFIA|GRINNING", "T|Golem Sofia|*THIS ONE'S* DESIGNATION IS VERIFIED." },
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|THINKING", "T|Sofia|\"Cool Sofia\"? What does that even mean? I'm already cool!" },
                        new object[] { "C|GWS:CONTINUE", "F|COOL SOFIA|EXCITED", "T|Cool Sofia|Well hey sweetheart, I'm the one with the word in my name." },
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|UNIMPRESSED", "F|COOL SOFIA|HAPPY", "T|Cool Sofia|I'll leave you to think that one through." },
                        new object[] { "C|GWS:CONTINUE", "F|GOLEM SOFIA|PLACID", "T|Cool Sofia|Anyway, I think you got my letter." },
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|EXCITED", "T|Sofia|Wait, that was you?" },
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|HAPPY", "T|Sofia|You brought me here?" },
                        new object[] { "C|GWS:CONTINUE", "F|COOL SOFIA|GRINNING", "T|Cool Sofia|Well darling, the way I see it, you brought yourself here via the winds of fate." },
                        new object[] { "C|GWS:CONTINUE", "F|COOL SOFIA|LAUGHING", "T|Cool Sofia|I was but the humble facillitator. [T:500]There was nothing stopping you from going back inside and drawing some lizards, you know." },
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|JUDGING", "T|Sofia|Hey, who's to say that in another universe I didn't?" },
                        new object[] { "C|GWS:CONTINUE", "F|COOL SOFIA|GRINNING", "F|SOFIA|WORRIED", "T|Cool Sofia|Hun, at this point, I think that anything you might have done before now is firmly in another universe." },
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|Can you please stop calling me cutesy names? It's really annoying." },
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|UNIMPRESSED", "T|Cool Sofia|No." },
                        new object[] { "C|GWS:CONTINUE", "F|COOL SOFIA|LAUGHING", "T|Sofia|Can you see me frowning? This is my frowny face." },
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|THINKING", "T|Sofia|Also, what on Earth are you talking about?" },
                        new object[] { "C|GWS:CONTINUE", "F|COOL SOFIA|EXCITED", "T|Cool Sofia|I'm talking about the fact that you're not on EARTH any more, sister." },
                        new object[] { "C|GWS:CONTINUE", "F|COOL SOFIA|GRINNING", "T|Cool Sofia|Welcome to [R]ULTRASOFIAWORLD[C:WHITE]. B)" },
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|WORRIED", "T|Sofia|Uh- Ultra-Sofi-whatnow?" },
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|UNIMPRESSED", "T|Sofia|Is this some bizarre, oddly narcissistic dream?" },
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|THINKING", "F|COOL SOFIA|HAPPY", "T|Cool Sofia|I'm afraid not even you could dream up somebody as awesome as me. No." },
                        new object[] { "C|GWS:CONTINUE", "T|Cool Sofia|This is ULTRASOFIAWORLD. A discrete hyperdimension dedicated to the true essence of SOFIA." },
                        new object[] { "C|GWS:CONTINUE", "T|Cool Sofia|Normally our worlds are inaccessible from eachother, but I found a way to bridge the gap, with help from a few select friends, so that I could finally bring you here." },
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|WORRIED", "F|GOLEM SOFIA|STARE", "T|Golem Sofia|HAVE YOU TWO LITERALLY JUST FORGOTTEN THAT I'M HERE?" },
                        new object[] { "C|GWS:CONTINUE", "T|Golem Sofia|I GUESS I'LL JUST LEAVE THEN, IF NOBODY HAS TIME FOR THE INTIMIDATING SENTINEL GOLEM." },
                        new object[] { "C|TIME:1000:ORSKIP", "F|SOFIA|UNIMPRESSED", "F|COOL SOFIA|LAUGHING", "T|Cool Sofia|Scram, buzzball." },
                        new object[] { "C|TIME:600:ORSKIP", "A|GOLEM SOFIA|750=0,600,20||||" },
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|There was no need for that.", "A|COOL SOFIA|250=-30,600,20||0.037=0.037,600,20||" },
                        new object[] { "C|GWS:CONTINUE", "D|GOLEM SOFIA", "F|SOFIA|CONSIDERING", "T|Sofia|But, you brought me here? Why?" },
                        new object[] { "C|GWS:CONTINUE", "F|COOL SOFIA|DOWNCAST", "T|Cool Sofia|Well, Sofia, you see..." },
                        new object[] { "C|GWS:CONTINUE", "T|Cool Sofia|Things are not all that great here in ULTRASOFIAWORLD..." },
                        new object[] { "C|GWS:CONTINUE", "T|Cool Sofia|In fact..." },
                        new object[] { "C|TIME:600:ORSKIP", "F|COOL SOFIA|JUDGING", "T|Cool Sofia|We're running out of SOFIA!" },
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|LAUGHING" },
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|You're... you're what???" },
                        new object[] { "C|GWS:CONTINUE", "F|COOL SOFIA|UNIMPRESSED", "T|Sofia|What does that even mean!" },
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|Really, it feels like you have quite enough of me here. [T:500]Like, really!" },
                        new object[] { "C|GWS:CONTINUE", "F|COOL SOFIA|DOWNCAST", "T|Cool Sofia|No, you don't know! You see, this land is not as it once was..." },
                        new object[] { "C|GWS:CONTINUE", "T|Cool Sofia|We don't have the [R]ESSENCE[C:WHITE] anymore, Sofia! We're losing our touch!" },
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|WORRIED", "T|Cool Sofia|If we are to survive here in SOFIAWORLD, we need more of that sweet, sweet [R]SOFIA ESSENCE[C:WHITE]." },
                        new object[] { "C|GWS:CONTINUE", "F|COOL SOFIA|CONSIDERING", "T|Cool Sofia|And you..." },
                        new object[] { "C|GWS:CONTINUE", "F|COOL SOFIA|GRINNING", "T|Cool Sofia|Your essence is so pure! A fresh, untainted, original Sofia!" },
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|UNIMPRESSED", "T|Sofia|Uhhh..." },
                        new object[] { "C|GWS:CONTINUE", "T|Cool Sofia|YOUR [R]ESSENCE[C:WHITE], SOFIA! LET ME TELL YOU ABOUT YOUR [R]ESSENCE[C:WHITE]!" },
                        new object[] { "C|GWS:CONTINUE", "T|Cool Sofia|With the power of an original Sofia, we can make this land anew..." },
                        new object[] { "C|GWS:CONTINUE", "T|Cool Sofia|We can restore all the [R]SOFIA[C:WHITE] to [R]ULTRASOFIAWORLD[C:WHITE]!" },
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|WORRIED", "T|Sofia|Okaaaaay..." },
                        new object[] { "C|GWS:CONTINUE", "F|COOL SOFIA|HAPPY", "T|Cool Sofia|We should start at once." },
                        new object[] { "C|GWS:CONTINUE", "T|Cool Sofia|I can take you to the King Sofia." },
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|THINKING", "T|Sofia|I should really just be going along with this at this point, but.." },
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|UNIMPRESSED", "T|Sofia|...who?!?!" },
                        new object[] { "C|GWS:CONTINUE", "T|Cool Sofia|The King Sofia! The one true ruler of this land, glory be to her." },
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|THINKING", "T|Sofia|Wait, but shouldn't it be the Queen Sofia?" },
                        new object[] { "C|GWS:CONTINUE", "T|Cool Sofia|Shhh, don't question it." },
                        new object[] { "C|GWS:CONTINUE", "F|COOL SOFIA|EXCITED", "T|Cool Sofia|Anyway, we must go quickly!" },
                        new object[] { "C|GWS:impos", "F|SOFIA|CONSIDERING", "T|Cool Sofia|Follow me!", new VoidDel(delegate()
                        {
                            Shell.RunQueue.Add(new VoidDel(delegate()
                            {
                                Button B = ButtonScripts.GetQuickButton("Follow Cool Sofia to the King Sofia.", ButtonScripts.DelegateFetch("runscript_SOFIA_KING_PRIMARY"));
                                B.MLCRecord = new String[] { "runscript_SOFIA_KING_PRIMARY" };
                                B.QuickMoveTo(new Vector2(640, 120));
                                Button B2 = ButtonScripts.GetQuickButton("Ditch her, wander off and do your own thing instead.", ButtonScripts.DelegateFetch("runscript_SOFIA_CROOKED_PRIMARY"));
                                B2.MLCRecord = new String[] { "runscript_SOFIA_CROOKED_PRIMARY" };
                                B2.QuickMoveTo(new Vector2(640, 240));
                                Button B3 = ButtonScripts.GetQuickButton("Hey, what the hell even is all of this anyway???", ButtonScripts.DelegateFetch("runscript_SOFIA_WHATTHEHELL"));
                                B3.MLCRecord = new String[] { "runscript_SOFIA_WHATTHEHELL" };
                                B3.QuickMoveTo(new Vector2(640, 360));
                                Shell.UpdateQueue.Add(B);
                                Shell.RenderQueue.Add(B);
                                Shell.UpdateQueue.Add(B2);
                                Shell.RenderQueue.Add(B2);
                    ...
                    break;
                case "SOFIA_WHATTHEHELL":
                    Script = new object[]
                    {
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|WORRIED", "D|#CBUTTONS", "T|Sofia|Hey, what the hell even is all of this anyway???" },
                        new object[] { "C|GWS:CONTINUE", "F|COOL SOFIA|HAPPY", "T|Cool Sofia|This is your destiny, bruh. Welcome to your TRUE PURPOSE OF BEING!" },
                        new object[] { "C|GWS:CONTINUE", "T|Sofia|Can't I just go back through the portal?" },
                        new object[] { "C|GWS:CONTINUE", "F|SOFIA|UNIMPRESSED", "F|COOL SOFIA|EXCITED", "T|Cool Sofia|Sorry, but I can't let that happen." },
                        new object[] { "C|GWS:CONTINUE", "F|COOL SOFIA|LAUGHING", "T|Cool Sofia|And besides, even if I wanted to let you go back, do you know how hard it is to open up an interdimensional portal?" },
                        new object[] { "C|GWS:CONTINUE", "F|COOL SOFIA|EXCITED", "T|Cool Sofia|We'd need time and a lot more [R]ESSENCE[C:WHITE]. It's just not feasible otherwise, which is another reason why you should hurry up and come with me now." },
                        new object[] { "C|GWS:impos", "F|SOFIA|CONSIDERING", "T|Cool Sofia|Follow me!", new VoidDel(delegate()
                        {
                            Shell.RunQueue.Add(new VoidDel(delegate()
                            {
